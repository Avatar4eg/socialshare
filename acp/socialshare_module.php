	...
	private function handle_settings()
	{
		...
		if ($request->is_set_post('submit'))
		{
			...
			if ($commit_to_db)
			{
				...
				$config->set('lotusjeff_socialshare_mymail_icon', $request->variable('lotusjeff_socialshare_mymail_icon', 1));
				$config->set('lotusjeff_socialshare_mymail_icon_seq', $request->variable('lotusjeff_socialshare_mymail_icon_seq', 15));
		...
		$template->assign_vars(array(
			...
			'LOTUSJEFF_SOCIALSHARE_MYMAIL_ICON'			=> $config['lotusjeff_socialshare_mymail_icon'],
			'LOTUSJEFF_SOCIALSHARE_MYMAIL_ICON_SEQ'		=> $config['lotusjeff_socialshare_mymail_icon_seq'],
